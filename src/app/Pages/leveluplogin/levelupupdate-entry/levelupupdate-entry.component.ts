...
@Component({
  selector: 'app-levelupupdate-entry',
  templateUrl: './levelupupdate-entry.component.html',
  styleUrls: ['./levelupupdate-entry.component.css']
})
export class LevelupupdateEntryComponent implements OnInit {
  id: string;
