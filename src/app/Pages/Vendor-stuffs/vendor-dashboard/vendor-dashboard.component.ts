...
export class VendorDashboardComponent implements OnInit {
  ...
  getWidgetData() {
    this.dserv
      .getWidgetDataForVendor(this.loggedInUserId, this.cVendorId)
      .subscribe((data) => {
        this.widgetData = data;
        this.widget1 = this.widgetData[0]; //My Work Items
        this.widget2 = this.widgetData[1]; //Job Requests
        this.widget4 = this.widgetData[2]; //Active Job Requests
        this.widget5 = this.widgetData[3]; //Total Selected Candidates
        this.widget6 = this.widgetData[4]; //Total On-boarded Candidates
  ...
  getActiveRequestsData() {
    this.dserv
      .getBUsAndJobRequestCountForVendor(this.cVendorId)
      .subscribe((data) => {
  ...
  getJobRequestAgingCount() {
    this.dserv
      .getJobRequestAgingCountForVendor(this.cVendorId)
      .subscribe((data) => {
  ...
  LatestJobRequests() {
    this.dserv
      .getLatestJobRequestsForVendor(this.cVendorId)
      .subscribe((data) => {
  ...
  JobRequestStagesCount() {
    this.dserv
      .getAllJobRequestStagesCountForVendor(this.cVendorId)
      .subscribe((data) => {
   ...
   */
  gotoMyJobRequests() {
    this._router.navigate(['hirepros/my-job-requests', this.cVendorId]);
  }
  /**
