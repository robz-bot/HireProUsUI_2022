...
@Component({
  ...
  templateUrl: './internal-round2.component.html',
  styleUrls: ['./internal-round2.component.css'],
})
export class InternalRound2Component implements OnInit {
  subMenuName: string;
  constructor(
  ...
  searchInterviewScheduledList() {
    ...
    if (
      ...
      this.resetBtn = true;
      this.rserv
        .searchInterviewScheduledList('2', this.searchDto)
        .subscribe((data) => {
  ...
  searchForSchedule() {
    ...
    if (
      ...
      this.resetBtn = true;
      this.rserv.searchForSchedule('2', this.searchDto).subscribe((data) => {
      ...
      this.rserv
        ...
        .subscribe((data) => {
          ...
          if (this.datares.status == 1) {
            ...
            closeModal();
            this.alertify.updatedMsg('Interview Schedule');
            this.getInterviewScheduledList();
            this.getForSchedule();
          }
        });
  ...
  getForSchedule() {
    ...
    this.rserv.getForSchedule('2').subscribe((data) => {
      console.log(data);
      this.loader = 0;
      this.ShortlistedCandidatesList = data;
    });
