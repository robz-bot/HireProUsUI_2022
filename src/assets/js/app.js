...
function closeModal() {
  ...
  $("#addMainMenuModal").modal("hide");
  $("#addRoleMenuMappingModal").modal("hide");
  $("#addSubMenuModal").modal("hide");
  $("#searchModal").modal("hide");
  $("#addModal").modal("hide");
  $("#editMainMenuModal").modal("hide");
  $("#editSubMenuModal").modal("hide");
  $("#scheduleModel").modal("hide");
  $("#statusModel").modal("hide");
  $("#OnboardModel").modal("hide");
  $("#updateOnboardModel").modal("hide");
  $("#updateScheduleModel").modal("hide");
}
function openModal() {
...
function CandidateImageUpdate() {
  $("#CandidateImage").trigger("click");
}
function CandidateResumeUpdate() {
  $("#CandidateResumeUpdate").trigger("click");
}
function scrollDiv() {
  var elmnt = document.getElementById("element_within_div");
  var x = elmnt.scrollLeft;
}

function panelScrollBar() {
  var e = document.getElementById("element_Outside_div").offsetTop;
  alert(e);
  document.getElementById("element_within_div").scrollTop = e - 10;
}
